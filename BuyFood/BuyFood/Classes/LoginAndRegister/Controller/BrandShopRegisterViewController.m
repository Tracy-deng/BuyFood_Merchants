...
@interface BrandShopRegisterViewController ()<UITableViewDelegate, UITableViewDataSource, CLLocationManagerDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.row == 2)
    {
        ...
        [self.contentBtn addTarget:self action:@selector(chooseClassBtnClick:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)chooseClassBtnClick:(UIButton* )sender
{
