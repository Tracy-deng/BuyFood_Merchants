...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setShopsImageName:@"shopsImage" andShopsNameLabel:@"新鲜大白菜" andShopsWeight:@"500g" andShopsSpecifications:@"/份" andShopsOriginalPriceTitle:@"原价" andShopsOriginalPrice:@"6.00" andShopsPromotionPriceTitle:@"团购价" andShopsPromotionPrice:@"5.00"];
    return cell;
}
