...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        if ([cmp1 day] == [cmp2 day]) { // 今天
            formatter.dateFormat =[NSString stringWithFormat:@"%@ HH:mm", NSLocalizedString(@"MJTodayText",nil)];
        ...
        // 3.显示日期
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@：%@", NSLocalizedString(@"MJLastUpdateText",nil),time];
    } else {
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@：%@", NSLocalizedString(@"MJLastUpdateText",nil), NSLocalizedString(@"MJNoRecordText",nil)];
    }
}
